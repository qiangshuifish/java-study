...
public class Subscribe {
    ...
    public static void main(String[] args) throws IOException {
        Subscribe subscribe1 = new Subscribe(1, "Subscribe1");
        Subscribe subscribe2 = new Subscribe(1, "Subscribe2");

        subscribe1.handMsg(QUEUE_NAME+"1");
        subscribe2.handMsg(QUEUE_NAME+"2");
    }

    public void handMsg(String queueName) throws IOException {
